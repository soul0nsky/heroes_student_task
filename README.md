...
### ___Детальное описание и доказательство алгоритмов файл `ДОКАЗАТЕЛЬСТВА_СЛОЖНОСТИ.md` в папке `docs`___
...
├── artifacts/
│   ├── heroes_student_task.zip                 
│   ├── heroes_student_task.tgz 
...
- Можно отобразить количество жизней
- Можно отобразить нумерацию
- Правильно пронумерованы имена юнитов
...
- `obf.jar` — скомпилированная реализация
